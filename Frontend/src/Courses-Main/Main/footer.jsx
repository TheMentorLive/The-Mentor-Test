...
const SocialIcon = ({ icon: Icon }) => (
  <Icon className="social-icon hover:text-[#3284e1]" size={30} />
);
// Footer component
const Footer = () => {
  ...
  return (
    <div className='bg-[#000300] mx-auto  py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
      ...
      <div className='ml-28 '>
        <h1 className='w-full text-3xl lg:text-4xl xl:text-5xl font-bold text-[#3284e1]'>GenAI Learning</h1>
        <p className='py-4'>
      ...
      <div className='lg:col-span-2 mr-28 flex justify-between mt-6'>
