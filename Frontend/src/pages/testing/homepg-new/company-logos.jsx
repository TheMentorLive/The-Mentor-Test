export default function CompanyLogos() {
  return (
    <section className="">
      <hr className="border-t border-gray-300 px-4 pt-5 my-4 " />
      <div className="container md:px-6 pb-5">
        <h2 className="text-center text-lg font-medium text-gray-600 mb-12">
          OVER 5000 STUDENTS AND 1000 EMPLOYERS ARE ALREADY USING GEN AI LEARNING.
        </h2>
        <div className="flex items-center justify-center gap-8 md:gap-12 lg:ml-20 flex-wrap">
          <img
