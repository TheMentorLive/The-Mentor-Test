...
function Part1() {
  return (
    <div className="App">
      {/* Navbar */}
      <header className="bg-white shadow-md ml-20 mr-20">
      ...
      <main className="bg-gray-50 py-16">
        <div className="container mx-auto flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-8">
          ...
          <div className="text-center md:text-left ml-40 md:w-1/2">
            <p className="text-gray-500">One stop solution for all edtech needs</p>
          ...
          <div className="md:w-1/2 flex justify-center">
            <img src="path_to_your_image" alt="Illustration of AI learning" className="rounded-lg shadow-lg" />
          </div>
        </div>
