      ...
      <div className="flex flex-col w-full max-w-5xl bg-white rounded-lg shadow-lg p-8 mt-8">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 md:pr-8">
            <h1 className="text-4xl font-bold mb-4">{test.description}</h1>
            <div className="flex space-x-12">
              <div>
                <p className="text-sm text-gray-500">Test duration</p>
                <p className="text-lg font-medium">{test.duration} mins</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">No. of questions</p>
                <p className="text-lg font-medium">{test.questions.length} questions</p>
              </div>
            </div>
          </div>
