...
export default function Banner() {
  ...
  return (
    <React.Fragment>
      <section className="ml-1 mt-10 md:mt-0 lg:mt-0 md:ml-[122px] md:mr-[52px] md:py-10  flex justify-center items-center">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                <h1 className="text-[36px] sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl/none font-bold opacity-80 tracking-tighter">
